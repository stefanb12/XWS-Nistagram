...
namespace ProfileMicroservice.Database
{
    public class UserDbContext : DbContext
    {
        ...
        public DbSet<ProfileFollower> FollowerProfiles { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Profile>().HasData(
                ...
                new Profile { Id = 2, Username = "user2", Password = "pass2", Name = "name2", Email = "user2@gmail.com", MobilePhone = "+381 60 55 88 444", Gender = Gender.Male, DateOfBirth = new DateTime(1998, 12, 20), UserRole = UserMicroservice.Model.Enum.UserRole.Agent, ProfilePicture = "path", Private = false, Website = "WebSite", Biography = "bio", Deactivated = false, Category = UserCategory.Regular, ProfileSettingsId = 2 },
                new Profile { Id = 3, Username = "user3", Password = "pass3", Name = "name3", Email = "user3@gmail.com", MobilePhone = "+381 60 55 88 444", Gender = Gender.Male, DateOfBirth = new DateTime(1998, 12, 20), UserRole = UserMicroservice.Model.Enum.UserRole.Admin, ProfileSettingsId = 3 },
                new Profile { Id = 4, Username = "user4", Password = "pass4", Name = "name4", Email = "user2@gmail.com", MobilePhone = "+381 60 55 88 444", Gender = Gender.Male, DateOfBirth = new DateTime(1998, 12, 20), UserRole = UserMicroservice.Model.Enum.UserRole.Agent, ProfilePicture = "path", Private = false, Website = "WebSite", Biography = "bio", Deactivated = false, Category = UserCategory.Regular, ProfileSettingsId = 4 },
                new Profile { Id = 5, Username = "user5", Password = "pass5", Name = "name5", Email = "user2@gmail.com", MobilePhone = "+381 60 55 88 444", Gender = Gender.Male, DateOfBirth = new DateTime(1998, 12, 20), UserRole = UserMicroservice.Model.Enum.UserRole.Agent, ProfilePicture = "path", Private = false, Website = "WebSite", Biography = "bio", Deactivated = false, Category = UserCategory.Regular, ProfileSettingsId = 5 }
            );
            ...
            modelBuilder.Entity<ProfileFollowing>().HasData(
                ...
                new ProfileFollowing { ProfileId = 2, FollowingId = 3 }
            );
