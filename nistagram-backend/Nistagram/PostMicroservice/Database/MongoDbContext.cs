    ...
    public class MongoDbContext : IMongoDbContext
    {
        ...
        private IEnumerable<Post> CreatePostData()
        {
            var postData = new List<Post> {
                new Post { Tags = new List<string> {"Nature", "Waterfall" } , Description = "Nature", PublishingDate = new DateTime(2021, 02, 1, 1, 1, 1), Location = new Location { Address = "", City = "Belgrade", Country = "Serbia"}, Comments = new List<Comment> { new Comment { Text = "Excellent", Date = new DateTime(2021, 05, 30, 10, 10, 10), Publisher = new Profile { Username = "user1", OriginalId = 1, IsPrivate = false } } },  Publisher = new Profile { Username = "user1", OriginalId = 1, IsPrivate = false }, Contents = new List<Content> { new Content { ImageName = "2212424861.png" } } },
                new Post { Description = "Waterfall", PublishingDate = new DateTime(2021, 02, 2, 14, 14, 14), Location = new Location { Address = "Bulevar Cara Lazara", City = "Novi Sad", Country = "Serbia"}, Comments = new List<Comment> { new Comment { Text = "Wow!", Date = new DateTime(2021, 06, 1, 15, 16, 15), Publisher = new Profile { Username = "user2", OriginalId = 2, IsPrivate = false } }, new Comment { Text = "Wooow!", Date = new DateTime(2021, 06, 1, 15, 17, 15), Publisher = new Profile { Username = "user2", OriginalId = 2, IsPrivate = false } }, new Comment { Text = "Wow!", Date = new DateTime(2021, 06, 1, 15, 15, 15), Publisher = new Profile { Username = "user2", OriginalId = 2, IsPrivate = false } }, new Comment { Text = "Woooow!", Date = new DateTime(2021, 06, 1, 18, 15, 15), Publisher = new Profile { Username = "user1", OriginalId = 1, IsPrivate = false } } },  Publisher = new Profile { Username = "user1", OriginalId = 1, IsPrivate = false }, Contents = new List<Content> { new Content { ImageName = "2212424862.png" } } },
