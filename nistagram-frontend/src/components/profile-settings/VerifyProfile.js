...
class VerifyProfile extends Component {
  constructor(props) {
    ...
    this.handleFirstNameInputChange =
      this.handleFirstNameInputChange.bind(this);
  ...
  sendVerificationRequest = () => {
    ProfileVerificationRequestService.sendVerificationRequest(
      ...
      if (res.status == 200) {
        ...
        this.setState({
          showSnackbar: true,
          snackBarMessage:
            "Verification request for your profile already exists!",
